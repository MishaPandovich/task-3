ymaps.ready(function () {
    ...
    myPlacemarkOne = new ymaps.Placemark(myMap.getCenter(), {
      hintContent: 'Режим работы:<br> ПН-ПТ с 9:00 до 18:00,<br> СБ-ВС с 10:00 до 20:00 <br> Обед с 12:00 до 13:00'
    }, {
      // Опции.
    ...
    myPlacemarkTwo = new ymaps.Placemark([44.770181, 39.876085], {
      hintContent: 'Режим работы:<br> ПН-ПТ с 8:00 до 17:00,<br> СБ-ВС с 9:00 до 20:00 <br> Обед с 13:00 до 14:00'
    }, {
      // Опции.
      // Необходимо указать данный тип макета.
    ...
    myPlacemarkThree = new ymaps.Placemark([44.758013, 39.871594], {
        hintContent: 'Режим работы:<br> ПН-ПТ с 9:00 до 18:00,<br> СБ-ВС с 10:00 до 19:00 <br> Без обеда'
    }, {
        // Опции.
        // Необходимо указать данный тип макета.
        iconLayout: 'default#imageWithContent',
